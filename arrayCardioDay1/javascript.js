    ...
    const inventors = [
     ...
     // Long Version*********************************** 
    //   const bornIn1500 = inventors.filter( (obj) => {
    //       if(obj.year <1600 && obj.year >=1500){
    //           return true;
    //       }
    //   });
      //**********************************************
    ...
    //   const nameSorted = inventors.sort(function(a,b){
    //       if(a.year >b.year){
    //           return 1;
    //       }
    //       else {
    ...
    const nameSorted = inventors.sort((a,b)=> a.year > b.year ? 1 : -1);
    ...
    //                 .filter( street => street.includes('de')) ;
      ...
      const inventorLastNameSort = inventors.sort( (a,b) => a.last[0]>b.last[0] ? -1 : 1)

      console.table(inventorLastNameSort);
      ...
      const peopleLastNameSort = people
                                 .map( person => person.split(', '))
                                 .sort((a,b) => a > b ? 1 : -1);

      console.table(peopleLastNameSort);
    //   console.log(peopleLastNameSort);
